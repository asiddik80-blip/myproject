...
const API_KEY = "alesuperjuve@gmail.com_AzRHko5CKyMHrTp3gSv7KEb2ZLtiNew2lNlqg3vC3MmwPRcKJisYiKaOcKc8vyw3";
...
function convertPdfToJson(apiKey, uploadedFileUrl, password, pages, destinationFile) {
    ...
    var jsonPayload = JSON.stringify({
        ...
        pages: pages, 
        url: uploadedFileUrl,
        async: false,  // Tambahkan ini
        storeResult: true // Simpan hasilnya di PDF.co storage
    });
