      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.html">
            ...
            <h3 class="text-success">KBIH ACEH</h3>
          </a>
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center">
          <h5 class="mb-0 font-weight-medium d-none d-lg-flex">Welcome to KBIH Aceh Tamiang!</h5>
          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body performane-indicator-card">
                    <div class="d-sm-flex">
                      <h4 class="card-title flex-shrink-1">Keberangkatan Umroh</h4>
                    ...
                    <div class="d-sm-flex flex-wrap mt-3">
                      <div class="d-flex align-items-center">
                        ...
                        <p class="mb-0 ms-2 text-muted font-weight-semibold">Mendaftar (2098)</p>
                      </div>
                      <div class="d-flex align-items-center">
                        <span class="dot-indicator bg-info ms-2"></span>
                        <p class="mb-0 ms-2 text-muted font-weight-semibold"> Berangkat (1123)</p>
                      </div>
                      <div class="d-flex align-items-center">
                        <span class="dot-indicator bg-danger ms-2"></span>
                        <p class="mb-0 ms-2 text-muted font-weight-semibold">Batal (876)</p>
                      </div>
                    </div>
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Asal Jamaah</h4>
                    ...
                    <div class="table-responsive border rounded p-1">
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="stellar/dist/assets/images/faces/face1.jpg" alt="profile image"> Katie Holmes
                            </td>
                            <td>$3621</td>
                            <td><img src="stellar/dist/assets/images/dashboard/alipay.png" alt="alipay" class="gateway-icon me-2"> alipay</td>
                            <td>04 Jun 2019</td>
                            <td>18 Jul 2019</td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="stellar/dist/assets/images/faces/face2.jpg" alt="profile image"> Minnie Copeland
                            </td>
                            <td>$6245</td>
                            <td><img src="stellar/dist/assets/images/dashboard/paypal.png" alt="alipay" class="gateway-icon me-2"> Paypal</td>
                            <td>25 Sep 2019</td>
                            <td>07 Oct 2019</td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="stellar/dist/assets/images/faces/face3.jpg" alt="profile image"> Rodney Sims
                            </td>
                            <td>$9265</td>
                            <td><img src="stellar/dist/assets/images/dashboard/alipay.png" alt="alipay" class="gateway-icon me-2"> alipay</td>
                            <td>12 dec 2019</td>
                          ...
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="stellar/dist/assets/images/faces/face4.jpg" alt="profile image"> Carolyn Barker
                            </td>
                            <td>$2263</td>
                            <td><img src="stellar/dist/assets/images/dashboard/alipay.png" alt="alipay" class="gateway-icon me-2"> alipay</td>
                            <td>30 Sep 2019</td>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex mt-4 py-3 border-bottom">
                      <img class="img-sm rounded-circle" src="stellar/dist/assets/images/faces/face3.jpg" alt="profile image">
                    ...
                    <div class="d-flex py-3 border-bottom">
                      <img class="img-sm rounded-circle" src="stellar/dist/assets/images/faces/face2.jpg">
                      <div class="wrapper ms-2">
                    ...
                    <div class="d-flex py-3 border-bottom">
                      <img class="img-sm rounded-circle" src="stellar/dist/assets/images/faces/face4.jpg" alt="profile image">
                      <div class="wrapper ms-2">
                    ...
                    <div class="d-flex py-3  border-bottom">
                      <img class="img-sm rounded-circle" src="stellar/dist/assets/images/faces/face8.jpg">
                      <div class="wrapper ms-2">
                    ...
                    <div class="d-flex pt-3">
                      <img class="img-sm rounded-circle" src="stellar/dist/assets/images/faces/face7.jpg">
                      <div class="wrapper ms-2">
