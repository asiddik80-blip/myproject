    ...
    <div class="card">
        <div class="card-body">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Upload Berkas PDF - Extract Table dengan API Adobe (Resmi)') }}
            </h2>
            <p class="mb-3">Silakan pilih berkas PDF yang akan diupload (adobeekstrakpdf)</p>
            ...
            <form action="{{ url('adobeekstrakpdf/extract') }}" method="POST" enctype="multipart/form-data">
                @csrf
