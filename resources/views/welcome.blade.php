<!DOCTYPE html>
<html lang="lang={{ App::getLocale() }}" dir="{{ session('locale') == 'ar' ? 'rtl' : 'ltr' }}">

<head>
  <meta charset="utf-8">
  <meta content="width=device-width, initial-scale=1.0" name="viewport">
  <title>KBIH Aceh Tamiang</title>
  ...
  <link rel="stylesheet" href="{{ session('locale') == 'ar' ? asset('landing/assets/css/rtl.css') : asset('landing/assets/css/style.css') }}">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <h1 class="sitename">RAOUDA</h1>
      </a>

      <nav id="navmenu" class="navmenu">
        <ul>
          <li><a href="#hero" class="active">{{ session('locale') == 'ar' ? 'المنزل' : 'Home' }}</a></li>
          <li><a href="#about">{{ session('locale') == 'ar' ? 'حج' : 'Haji' }}</a></li>

<li><a href="#services">{{ session('locale') == 'ar' ? 'عمرة' : 'Umrah' }}</a></li>
<li><a href="#portfolio">{{ session('locale') == 'ar' ? 'مكة' : 'Makkah' }}</a></li>
<li><a href="#team">{{ session('locale') == 'ar' ? 'المدينة' : 'Madinah' }}</a></li>
<li><a href="#contact">{{ session('locale') == 'ar' ? 'تواصل' : 'Contact' }}</a></li>
<li><a href="{{ route('login') }}">{{ session('locale') == 'ar' ? 'تسجيل الدخول' : 'Login' }}</a></li>

          <li class="dropdown">
    <a href="#"><span>{{ session('locale') == 'ar' ? 'اللغة': 'Language' }}</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
    <ul>
        <li><a href="{{ route('setLanguage', ['lang' => 'ar']) }}">Arabic</a></li>
        <li><a href="{{ route('setLanguage', ['lang' => 'en']) }}">English</a></li>
        <li><a href="{{ route('setLanguage', ['lang' => 'fr']) }}">Français </a></li>
        <li><a href="{{ route('setLanguage', ['lang' => 'idn']) }}">Indonesia</a></li>
    </ul>
</li>
          ...
          <div class="carousel-container">
            <h2 class="animate__animated animate__fadeInDown">
               {{ __('messages.welcome') }}
                ...
                <p class="animate__animated animate__fadeInUp">{{ __('messages.makkah') }}</p>
              <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">{{ session('locale') == 'ar' ? 'اقرأ المزيد': 'Read More' }}</a>
          </div>
        </div>
    ...
    <section id="about" class="about section">
      ...
      <div class="container">
        ...
        <div class="row position-relative">
          ...
          <div class="col-lg-7 about-img" data-aos="zoom-out" data-aos-delay="200"><img src="landing/assets/img/about.jpg"></div>
        ...
        <div class="row g-0">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="landing/assets/img/gallery/gallery-1.jpg" class="glightbox" data-gallery="images-gallery">
                <img src="landing/assets/img/gallery/gallery-1.jpg" alt="" class="img-fluid">
              </a>
            </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="landing/assets/img/gallery/gallery-2.jpg" class="glightbox" data-gallery="images-gallery">
                <img src="landing/assets/img/gallery/gallery-2.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div><!-- End Gallery Item -->
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="landing/assets/img/gallery/gallery-3.jpg" class="glightbox" data-gallery="images-gallery">
                <img src="landing/assets/img/gallery/gallery-3.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div><!-- End Gallery Item -->
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="landing/assets/img/gallery/gallery-4.jpg" class="glightbox" data-gallery="images-gallery">
                <img src="landing/assets/img/gallery/gallery-4.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div><!-- End Gallery Item -->
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="landing/assets/img/gallery/gallery-5.jpg" class="glightbox" data-gallery="images-gallery">
                <img src="landing/assets/img/gallery/gallery-5.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div><!-- End Gallery Item -->
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="landing/assets/img/gallery/gallery-6.jpg" class="glightbox" data-gallery="images-gallery">
                <img src="landing/assets/img/gallery/gallery-6.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div><!-- End Gallery Item -->
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="landing/assets/img/gallery/gallery-7.jpg" class="glightbox" data-gallery="images-gallery">
                <img src="landing/assets/img/gallery/gallery-7.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div><!-- End Gallery Item -->
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="landing/assets/img/gallery/gallery-8.jpg" class="glightbox" data-gallery="images-gallery">
                <img src="landing/assets/img/gallery/gallery-8.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div><!-- End Gallery Item -->
